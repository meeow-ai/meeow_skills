...
4.
[7/15/2026 11:21 AM] Daniel W: Architecture: Tailwind is allowed and encouraged by default (v4 preferred,
...
5. Typography (numeric condition, replacing intent-based judgment): for display-type
   ...
   it must be 0. CJK-specific issues (line-break avoidance rules, mixed-script spacing,
   etc.) are handled in LOCALE-zh.md, not here, to keep this language-agnostic layer
   free of language-specific rules.
...
2.
[7/15/2026 11:21 AM] Daniel W: scenario_mode choice and rationale (including the auto-switch trigger word, if any)
...
[7/15/2026 11:21 AM] Daniel W: - "I think this looks/works better" — an aesthetic preference is not a conflict, it's
